...
export default class Main extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch(`https://api.nasa.gov/planetary/apod?api_key=g5EOHFgzk1FTPU1LqDOOeAfC5d1agD4hFM6FTC4a&start_date=2020-08-19&end_date=2020-08-19`)
      .then((res) => res.json())
      .then((res) => {
        if (res.code !== 404) {
          this.setState({
      ...
      <Content>
        ...
        </ContentTitle>
        {
          (media_type == "image")
            ...
            :
            <Apod>
              <iframe width="100%" height="300px" style={{maxWidth: 700}} src={url} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen>
              </iframe>
              <ApodInfo style={{ margin: '20px' }}>
                <Text type="secondary">
                  Astronomy Picture of the Day: &nbsp;
